local levelDefinitions = {
    ...
    },
    {
        ...
        duration = 40,
        nav = {fuckeryRate = 0.1},
        ventgas = {gasGrowthRate = 13, wasteGrowthRate = 8},
    ...
    },
    {
        ...
        duration = 75,
        nav = {fuckeryRate = 0.1},
        ventgas = {gasGrowthRate = 7, wasteGrowthRate = 5},
        spinner = {initialPills = 0, timeToPill = 8, wheelSpeed = 7},
        misslowcommand = {speed = 30, timeToMissile = 19},
        plumbing = {fluidRate = 0.23, startBufferFluidRate = 0.07},
        cutsceneDialogue = {
