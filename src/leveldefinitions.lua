local levelDefinitions = {
    ...
    },
    {
        ...
        cutsceneDialogue = {
            'So, your pilot just quit. Good riddance, I say -- turns out the autopilot was doing most of his work anyway.',
    ...
    },
    {
        ...
        spinner = {initialPills = 1, timeToPill = 4, wheelSpeed = 7},
        cutsceneDialogue = {
    ...
    },
    {
        ...
        spinner = {initialPills = 0, timeToPill = 6, wheelSpeed = 7},
    ...
    },
    {
        ...
        spinner = {initialPills = 0, timeToPill = 7, wheelSpeed = 7},
